...
<div class="agree_box">
	<form id="agreeFrm" name="agreeFrm" action="/join/MemberRegist.do" method="post">
		<h3 class="icon2">이용약관(필수)</h3>
		<div class="cont" tabinde="0">
			이용약관 내용~
		</div>
		<div class="check">
			필수(
